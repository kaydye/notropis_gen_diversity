...
#export file: txt file of the data for NewHybrids
...
#Load data
#args <- c("~/Nmegalops/hybrid/newhybrids/notr_final.recode.vcf", "newhybrids_input.txt")
...
#Note: these aren't actually locus names, they are the individuals, but in the data file it is called "Locus Names" $
