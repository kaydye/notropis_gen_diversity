...
#17 duplicate SNPs, some SNPs were identified as Singletons in N.amabilis but Doubletons in N.megalops
...
#The Final_Filter.count in the SOL folder needs to be exported and evaluated using SOL_filter_no_mac to determine the best filtering path
...
#Identified 7 pair of both between and within library technical replicates
